...
- p, ChdleGFtcGxlQGFyZ20pLmlvEgJkZXhfY29ubl9pZA, applications, *, *, allow
...
A new CLI command `argocd app health-check` has been introduced to perform a comprehensive health check on an ArgoCD application. This command provides detailed health information beyond basic status checks.
