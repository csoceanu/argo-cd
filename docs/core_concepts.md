...
* **Health Check** A comprehensive assessment of an application's operational status, including sync status, resource health, pod readiness, service connectivity, and resource drift detection.
