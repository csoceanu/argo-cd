...
func NewCommand() *cobra.Command {
	...
	command.PersistentFlags().StringVar(&clientOpts.PortForwardNamespace, "port-forward-namespace", config.GetFlag("port-forward-namespace", ""), "Namespace name which should be used for port forwarding (DEPRECATED: use --namespace instead)")
	command.PersistentFlags().StringVar(&clientOpts.PortForwardNamespace, "namespace", config.GetFlag("namespace", ""), "Namespace for port forwarding and server connection")
